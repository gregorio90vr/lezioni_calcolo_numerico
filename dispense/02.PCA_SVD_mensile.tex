...
% le figure sono prodotte da R/lezione_pca_mensile.R in output/pca_mensile/
\graphicspath{{}}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{../output/pca_mensile/step1_curve_livelli_m.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{../output/pca_mensile/step1_delta_mensili.pdf}
...
\centering
\includegraphics[width=\textwidth]{../output/pca_mensile/step1_heatmap_correlazioni_m.pdf}
\end{minipage}\hfill
\begin{minipage}[t]{0.49\textwidth}
\centering
\includegraphics[width=\textwidth]{../output/pca_mensile/step1_correlazioni_3d_barre_m.pdf}
\end{minipage}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{../output/pca_mensile/step2_varianza_spiegata_m.pdf}
...
%\IfFileExists{output/pca_mensile/pca_summary_for_tex_m.tex}{%
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{../output/pca_mensile/step3_loadings_pc1_pc3_m.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.97\textwidth]{../output/pca_mensile/step3_scores_mensili_m.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{../output/pca_mensile/step3_confronto_ricostruzione_m.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.97\textwidth]{../output/pca_mensile/step3_ricostruzione_progressiva_m.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.88\textwidth]{../output/pca_mensile/sez5_curva_ricostruzione.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.88\textwidth]{../output/pca_mensile/sez5_convergenza_errore.pdf}
