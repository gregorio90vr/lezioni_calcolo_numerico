...
\begin{figure}[H]
\centering
\includegraphics[width=0.97\textwidth]{../output/04_pca_ecb/step3_scores_mensili_m.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.88\textwidth]{../output/04_pca_ecb/sez5_curva_ricostruzione.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.88\textwidth]{../output/04_pca_ecb/sez5_convergenza_errore.pdf}
