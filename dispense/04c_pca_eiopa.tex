% ============================================================
%  Dispensa 04c: PCA sulle Curve EIOPA (Risk-Free Rate)
%               Variante della dispensa 04 su fonte dati diversa
...
% le figure sono prodotte da R/04c_pca_eiopa.R in output/04c_pca_eiopa/
\graphicspath{{}}
...
arbitraria --- presente invece nell'analisi BCE della dispensa~04 --- tra
...
La differenza pi\`u importante rispetto alla curva BCE della dispensa~04 \`e il
...
$P(0,T)=e^{-r(T)T}$ (dispensa~04). EIOPA pubblica tassi in
...
Lo script \texttt{R/04c\_pca\_eiopa\_prep.R} estrae le prime 20 scadenze da tutti
gli archivi e produce il file \texttt{dati/04c\_eiopa\_spot.xlsx}
...
($0{,}02592$ significa $2{,}592\%$), mentre il file BCE della dispensa~04 li
...
una volta sola, in \texttt{04c\_pca\_eiopa\_prep.R}. Un punto base vale quindi
...
\begin{codebox}[Estrazione di una curva da un archivio (04c\_pca\_eiopa\_prep.R)]
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{../output/04c_pca_eiopa/step1_curve_livelli_m.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{../output/04c_pca_eiopa/step1_delta_mensili_m.pdf}
...
\centering
\includegraphics[width=\textwidth]{../output/04c_pca_eiopa/step1_heatmap_correlazioni_m.pdf}
\end{minipage}\hfill
\begin{minipage}[t]{0.49\textwidth}
\centering
\includegraphics[width=\textwidth]{../output/04c_pca_eiopa/step1_correlazioni_3d_barre_m.pdf}
\end{minipage}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{../output/04c_pca_eiopa/step2_varianza_spiegata_m.pdf}
...
\begin{keybox}[Risultati numerici (generati da \texttt{R/04c\_pca\_eiopa.R})]
\input{../output/04c_pca_eiopa/pca_summary_for_tex_m.tex}
\end{keybox}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{../output/04c_pca_eiopa/step3_loadings_pc1_pc3_m.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.97\textwidth]{../output/04c_pca_eiopa/step3_scores_mensili_m.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{../output/04c_pca_eiopa/step3_confronto_ricostruzione_m.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.97\textwidth]{../output/04c_pca_eiopa/step3_ricostruzione_progressiva_m.pdf}
...
# 1. Estrazione: una curva per archivio (04c_pca_eiopa_prep.R)
...
stessa geometria. La dispensa~04 svolge l'esercizio speculare (curva EIOPA su
loadings BCE).
\end{osservazione}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.88\textwidth]{../output/04c_pca_eiopa/sez5_curva_ricostruzione.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.88\textwidth]{../output/04c_pca_eiopa/sez5_convergenza_errore.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.88\textwidth]{../output/04c_pca_eiopa/sez5_errore_per_tenor.pdf}
