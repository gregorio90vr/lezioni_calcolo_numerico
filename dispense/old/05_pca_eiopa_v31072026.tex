% ============================================================
%  Dispensa 05: PCA sulle Curve EIOPA (Risk-Free Rate)
...
% le figure sono prodotte da R/05_pca_eiopa.R in output/05_pca_eiopa/
\graphicspath{{}}
...
Lo script \texttt{R/05\_pca\_eiopa\_prep.R} estrae le prime 20 scadenze da tutti
gli archivi e produce il file \texttt{dati/05\_eiopa\_spot.xlsx}
...
una volta sola, in \texttt{05\_pca\_eiopa\_prep.R}. Un punto base vale quindi
...
\begin{codebox}[Estrazione di una curva da un archivio (05\_pca\_eiopa\_prep.R)]
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{../output/05_pca_eiopa/step1_curve_livelli_m.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{../output/05_pca_eiopa/step1_delta_mensili_m.pdf}
...
\centering
\includegraphics[width=\textwidth]{../output/05_pca_eiopa/step1_heatmap_correlazioni_m.pdf}
\end{minipage}\hfill
\begin{minipage}[t]{0.49\textwidth}
\centering
\includegraphics[width=\textwidth]{../output/05_pca_eiopa/step1_correlazioni_3d_barre_m.pdf}
\end{minipage}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{../output/05_pca_eiopa/step2_varianza_spiegata_m.pdf}
...
\begin{keybox}[Risultati numerici (generati da \texttt{R/05\_pca\_eiopa.R})]
\input{../output/05_pca_eiopa/pca_summary_for_tex_m.tex}
\end{keybox}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{../output/05_pca_eiopa/step3_loadings_pc1_pc3_m.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.97\textwidth]{../output/05_pca_eiopa/step3_scores_mensili_m.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{../output/05_pca_eiopa/step3_confronto_ricostruzione_m.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.97\textwidth]{../output/05_pca_eiopa/step3_ricostruzione_progressiva_m.pdf}
...
# 1. Estrazione: una curva per archivio (05_pca_eiopa_prep.R)
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.88\textwidth]{../output/05_pca_eiopa/sez5_curva_ricostruzione.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.88\textwidth]{../output/05_pca_eiopa/sez5_convergenza_errore.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.88\textwidth]{../output/05_pca_eiopa/sez5_errore_per_tenor.pdf}
