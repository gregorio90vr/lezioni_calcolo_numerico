...
Rscript R/04_pca_ecb_prep.R             # Step 1: dati/data.csv → dati/pca_input_curves_1Y_20Y.xlsx
...
dati/tickersEUSA_v3.xlsx (par IRS EUR vs EURIBOR 6M)
...
**Lezione 03 — Smith-Wilson variazionale (`03_eiopa_rfr_smith_wilson.R`):** Derives Smith-Wilson from a minimum-energy variational principle (Lagrange multipliers, SPD projection). Ref: EIOPA-BoS-25-599 (Dec 2025, historical methodology). Input: `dati/tickersEUSA_v3.xlsx` (Bloomberg EUSA*, July 2025 worked example).
