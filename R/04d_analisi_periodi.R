...
#  cinque periodi macro evidenziati nella Sezione 3.3.3 della dispensa 04
...
#
#  La PCA e' calibrata ESATTAMENTE come in 04_pca_ecb.R (taglio al
#  31/12/2025): solo cosi' gli scores qui calcolati coincidono con quelli
#  della Figura 8 della dispensa.
#
#  Input : ../dati/04_ecb_spot.xlsx
#  Output: ../output/04d_analisi_periodi/   <-- cartella SEPARATA, nessun
...
output_dir <- "../output/04d_analisi_periodi"
...
# ==============================================================
# 1. DATI E PCA (identici a 04_pca_ecb.R)
# ==============================================================
