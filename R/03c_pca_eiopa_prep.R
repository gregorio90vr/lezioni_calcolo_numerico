...
#   P(0,T) = (1 + r(T))^(-T),
# a differenza della curva BCE della lezione 03 che e' in capitalizzazione
...
# PUNTI PERCENTUALI (2.592), la stessa convenzione del file 03_ecb_spot.xlsx,
# cosi' che 03c_pca_eiopa.R sia identico a 03_pca_ecb.R/03b_pca_ecb.R nella logica delle unita'
...
output_file_name <- "../dati/03c_eiopa_spot.xlsx"
