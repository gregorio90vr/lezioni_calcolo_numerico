...
#
#  A differenza di 03b_pca_ecb.R, che stima i loadings sull'intero
...
#
#  Input : ../dati/03_ecb_spot.xlsx (prodotto da 03_pca_ecb_prep.R)
#  Output: figure PDF e frammenti LaTeX in ../output/03_pca_ecb/
#
...
if (!file.exists(input_xlsx)) {
  stop(paste0("File non trovato: ", input_xlsx,
              "\nEsegui prima 03_pca_ecb_prep.R oppure verifica il percorso."))
}
...
# diversi, R^m e R^n.)
#
# Output: output/03_pca_ecb/svd_geometria_esempio.pdf, condivisa anche
# dalla dispensa 03b (stesso percorso, illustrazione indipendente dal
