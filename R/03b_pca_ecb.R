...
#  Output: figure PDF e frammenti LaTeX in ../output/03b_pca_ecb/
#
...
# Fonte: dati/03b_ecb_spot_20260730.xlsx (ECB Data Portal), foglio PCA_Input,
# una singola riga (gia' filtrata da 03_pca_ecb_prep.R).
input_xlsx2 <- "../dati/03b_ecb_spot_20260730.xlsx"
